...
WebUI.setText(findTestObject('Object Repository/Login/Page_Advantage Shopping/input_OR_username'), '123456')

WebUI.setText(findTestObject('Object Repository/Login/Page_Advantage Shopping/input_Username_password'), 'T3st')
